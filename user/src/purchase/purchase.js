...
function Purchase() {
  ...
  return (
    <div className="uk-card uk-card-default uk-card-body uk-width-1-2@m uk-position-top-center uk-position-large">
      <p><span className="priceFont">所有訂貨單</span><span  className="uk-position-top-right uk-position-medium"><a href="" uk-icon="icon: plus-circle; ratio: 1.3"></a></span></p>
      <table className="uk-table uk-table-hover uk-table-divider">
        <thead>
          <tr>
            <th>訂貨單編號</th>
